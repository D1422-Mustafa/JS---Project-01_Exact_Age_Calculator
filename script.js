...
const updateCountdown = () =>{
    ...
    let yaerOfAge = currentYear - dobYear;
    ...
    if (dayOfAge < 0) {
        //homework ==> instead of 30 get previous month day number.
        dayOfAge += 30;
        monthOfAge --;
    }
    if (hourOfAge < 0) {
    ...
    //Add values to DOM 
    years.innerHTML = yaerOfAge.toString().padStart(2, "0");
